...
bool mujoco_ros_msgs__msg__body_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mujoco_ros_msgs.msg._body_state.BodyState", full_classname_dest, 41) == 0);
  }
  mujoco_ros_msgs__msg__BodyState * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of BodyState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mujoco_ros_msgs.msg._body_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BodyState");
