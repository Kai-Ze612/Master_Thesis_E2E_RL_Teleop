...
bool mujoco_ros_msgs__msg__geom_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mujoco_ros_msgs.msg._geom_type.GeomType", full_classname_dest, 39) == 0);
  }
  mujoco_ros_msgs__msg__GeomType * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of GeomType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mujoco_ros_msgs.msg._geom_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeomType");
