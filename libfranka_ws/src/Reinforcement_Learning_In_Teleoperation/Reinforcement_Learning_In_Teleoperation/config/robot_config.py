...
TRAJECTORY_CENTER = np.array([0.3, 0.0, 0.6], dtype=np.float32)
...
REWARD_PREDICTION_WEIGHT = 0.0   # Weight for state prediction accuracy
REWARD_TRACKING_WEIGHT = 5.0    # Weight for tracking performance
