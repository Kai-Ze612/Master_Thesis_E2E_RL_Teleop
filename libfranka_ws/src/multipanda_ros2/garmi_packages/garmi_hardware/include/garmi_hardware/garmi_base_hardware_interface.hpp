...
class GarmiBaseHardwareInterface : public hardware_interface::SystemInterface{
...
private:
    ...
    HardwareID hw_id_ = HardwareID::Base;

    //=> values exposed to the controllers.
    // Command variable
    std::array<double, 2> hw_commands_joint_velocity_{0, 0};
    // State variables
    ...
    rclcpp::Logger getLogger() {
        return rclcpp::get_logger("GarmiBaseHardwareInterface");
    }
};
} // namespace garmi_hardware