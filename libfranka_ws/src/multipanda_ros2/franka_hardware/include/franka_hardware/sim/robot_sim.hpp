...
public:
    ...
    bool initializeIdentification(std::vector<double> Xb, double mountRho, double mountPhi);
...
private:
    ...
    bool has_identification_;
    bool has_gripper_;
    std::shared_ptr<panda_identification::Dynamics> dyn_;
    std::unique_ptr<panda_identification::Observers> obs_;
