...
namespace panda_identification {
    class Dynamics{
        public:
            ...
            Vector3d get_O_gravity(); // 3d gravity vector in base frame
            VectorXd get_tau_G(VectorXd q); // gravity compensation torque
            VectorXd get_tau_F(VectorXd qd); // frictional torque
            VectorXd get_tau_model(VectorXd q, VectorXd qd, VectorXd qdd); // useful for trajectory
            MatrixXd get_C(VectorXd q, VectorXd qd); // full coriolis matrix
            MatrixXd get_M(VectorXd q); // full inertia matrix
            MatrixXd get_dM(VectorXd q, VectorXd qd); // M dot
        ...
        private:
            ...
            double XB_s1, XB_s2, XB_s3, XB_s4, XB_s5, XB_s6, XB_s7, XB_s8, XB_s9, XB_s10,
                ...
                XB_s60, XB_s61, XB_s62, XB_s63, XB_s64, XB_s65, XB_s66;   
