...
class DCNN(nn.Module):
    def __init__(self, beta, input_dims, n_actions, layer_size, n_layers):
        ...
        if __name__ == "__main__":
            self.scheduler = lr_scheduler.StepLR(self.optimizer, step_size=5_000_000, gamma=0.9) 
        else:
            self.scheduler = lr_scheduler.StepLR(self.optimizer, step_size=5_000, gamma=0.9)
