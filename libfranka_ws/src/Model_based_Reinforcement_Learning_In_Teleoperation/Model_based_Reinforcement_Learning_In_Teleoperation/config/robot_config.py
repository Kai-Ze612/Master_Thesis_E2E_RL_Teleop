...
KP_LOCAL = np.array([48.0, 48.0, 36.0, 36.0, 10.0, 6.0, 2.0], dtype=np.float32)
KD_LOCAL = np.array([12.0,  12.0,  9.0,  9.0,  2.5, 1.5, 0.5], dtype=np.float32)
...
DEFAULT_KP_REMOTE = np.array([48.0, 48.0, 36.0, 36.0, 10.0, 6.0, 2.0], dtype=np.float32)
DEFAULT_KD_REMOTE = np.array([12.0,  12.0,  9.0,  9.0,  2.5, 1.5, 0.5], dtype=np.float32)
