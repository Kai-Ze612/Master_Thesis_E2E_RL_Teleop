...
def read_bag_data(bag_path, local_topic, remote_topic):
    ...
    This function remains unchanged as it correctly reads all point data (x, y, z).
    """
...
def align_and_calculate_error_2d(df_local, df_remote):
    ...
    # 5. Calculate 2D Euclidean Error (MODIFIED: Excludes Z-axis)
    ...
    # Note: df_merged still contains z_local and z_remote, but they are ignored in the error metric.
