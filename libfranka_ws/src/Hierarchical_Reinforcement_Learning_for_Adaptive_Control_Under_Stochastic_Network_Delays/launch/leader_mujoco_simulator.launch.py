...
def generate_launch_description():
    ...
    local_robot_node = Node(
        ...
        namespace=ns, # Using 'ns' correctly places it in the "local_robot" namespace
        output='screen',
        parameters=[{
            'use_sim_time': True,
            'control_freq': 100,
            'pd_kp': [24.0, 24.0, 24.0, 10.0, 10.0, 6.0, 2.0],
            'pd_kd': [2.0, 2.0, 2.0, 1.0, 1.0, 1.0, 0.5],
