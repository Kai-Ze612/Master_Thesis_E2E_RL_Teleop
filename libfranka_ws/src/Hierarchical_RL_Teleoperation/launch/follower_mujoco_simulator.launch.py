...
def generate_launch_description():
    ...
    # Remote robot node (from your real robot setup)
    remote_simulated_node = Node(
        package='Hierarchical_Reinforcement_Learning_for_Adaptive_Control_Under_Stochastic_Network_Delays',
        executable='remote_simulated_node',
        name='remote_simulated_node',
        namespace=ns,
        output='screen',
        parameters=[{
            'use_sim_time': True,
    ...
    return LaunchDescription([
        ...
        remote_simulated_node,  # Using remote node instead of local node
        ...
        # Optional: Spawn tau controller automatically
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['joint_tau_controller', '-c', concatenate_ns(ns, 'controller_manager', True)],
            output='screen',
        ),
