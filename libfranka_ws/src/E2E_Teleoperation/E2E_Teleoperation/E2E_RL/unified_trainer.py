...
# [ReplayBuffer Class same as before - omitted for brevity]
class ReplayBuffer:
...
class UnifiedTrainer:
    ...
    def _collect_data(self, steps, random=False):
        ...
        for _ in range(steps):
            ...
            else: action = info['teacher_action']
    ...
    def train_stage3_sac(self):
        ...
        # FIX: Exclude encoder from critic optimizer to prevent override
        # We rely on actor optimizer to train encoder
        ...
        for step in range(cfg.TRAIN.STAGE3_STEPS):
            ...
            if self.buffer.size > cfg.TRAIN.BATCH_SIZE:
                ...
                if step % 100 == 0: self._log_debug_info(step, obs, action, info, metrics)
