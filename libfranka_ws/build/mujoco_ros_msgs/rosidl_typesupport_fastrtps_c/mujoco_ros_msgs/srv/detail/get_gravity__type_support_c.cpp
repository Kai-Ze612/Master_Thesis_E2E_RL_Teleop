  ...
  void * untyped_ros_message)
{
  ...
  _GetGravity_Request__ros_msg_type * ros_message = static_cast<_GetGravity_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: admin_hash
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _GetGravity_Response__ros_msg_type * ros_message = static_cast<_GetGravity_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: gravity
  {
    size_t size = 3;
    auto array_ptr = ros_message->gravity;
