  ...
  void * untyped_ros_message)
{
  ...
  _SetGravity_Request__ros_msg_type * ros_message = static_cast<_SetGravity_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: admin_hash
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _SetGravity_Response__ros_msg_type * ros_message = static_cast<_SetGravity_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
