  ...
  void * untyped_ros_message)
{
  ...
  _Reload_Request__ros_msg_type * ros_message = static_cast<_Reload_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: model
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _Reload_Response__ros_msg_type * ros_message = static_cast<_Reload_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
