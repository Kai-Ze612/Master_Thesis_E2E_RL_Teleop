  ...
  void * untyped_ros_message)
{
  ...
  _GetSimInfo_Request__ros_msg_type * ros_message = static_cast<_GetSimInfo_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, msg, SimInfo
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GetSimInfo_Response__ros_msg_type * ros_message = static_cast<_GetSimInfo_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
