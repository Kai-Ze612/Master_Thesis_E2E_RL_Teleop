...
bool mujoco_ros_msgs__msg__state_uint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mujoco_ros_msgs.msg._state_uint.StateUint", full_classname_dest, 41) == 0);
  }
  mujoco_ros_msgs__msg__StateUint * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of StateUint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mujoco_ros_msgs.msg._state_uint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateUint");
