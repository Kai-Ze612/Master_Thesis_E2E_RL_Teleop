...
bool mujoco_ros_msgs__msg__mocap_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mujoco_ros_msgs.msg._mocap_state.MocapState", full_classname_dest, 43) == 0);
  }
  mujoco_ros_msgs__msg__MocapState * ros_message = _ros_message;
  {  // name
  ...
  {  // pose
    ...
    geometry_msgs__msg__PoseStamped * dest = ros_message->pose.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of MocapState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mujoco_ros_msgs.msg._mocap_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MocapState");
