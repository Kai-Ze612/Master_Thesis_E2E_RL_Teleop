...
## Run the simulator for real robot arm
1. Start Mujoco simulator
```bash
ros2 launch Hierarchical_Reinforcement_Learning_for_Adaptive_Control_Under_Stochastic_Network_Delays follower_mujoco_simulator.launch.py
```
